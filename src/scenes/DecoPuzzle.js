...
export class DecoPuzzle extends Phaser.Scene
{
    ...
    preload ()
    {
        this.load.image('background', 'assets/decopuzzle/stemma-comune.png');
        this.load.image('logo', 'assets/decopuzzle/stemma-comune.png');
        this.load.image('box', 'assets/decopuzzle/stemma-comune.png');
        this.load.image('box-inside', 'assets/decopuzzle/stemma-comune.png');
        this.load.image('pic1', 'assets/decopuzzle/stemma-comune.png');
        this.load.image('pic2', 'assets/decopuzzle/logo-de-co.png');
        this.load.image('pic3', 'assets/decopuzzle/comune-acquaviva.png');
    }
    ...
    if (this.currentRound === 2) {
        ...
        size = 3;
        iterations = 6;
        title = 'Denominazione Comunale d\'Origine';
    }
    else if (this.currentRound === 3) {
        nextPhoto = 'pic3';
        size = 3;
    ...
    calculateScore() {
        ...
        this.scene.start('FineDecoPuzzle', { 
            score: finalScore, 
            time: timeElapsed 
        });
    }
