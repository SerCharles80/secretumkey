...
export class FineCamminami extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('salutoCamminami', 'assets/camminami/fine-camminami.png');
    }
    ...
    create(data) {
        ...
        const salutoImage = this.add.image(this.cameras.main.centerX, this.cameras.main.height * 0.1, 'salutoCamminami')
            .setOrigin(0.5, 0);
        ...
        const continueButton = createPrimaryButton(
            ...
            //versione con blocco
            () => this.scene.start('EportaVecchia')
