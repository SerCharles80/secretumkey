...
export class FineFortezzaGost extends Phaser.Scene {
    constructor() {
        super({ key: 'FineFortezzaGost' });
    }

    preload() {
        // Carica l'immagine di saluto
        this.load.image('salutoGhost', 'assets/fortezzagost/fine-fortezzaghost.png');
    }
    ...
    create(data) {
        ...
        const salutoImage = this.add.image(this.cameras.main.centerX, this.cameras.main.height * 0.1, 'salutoGhost')
            .setOrigin(0.5, 0);
