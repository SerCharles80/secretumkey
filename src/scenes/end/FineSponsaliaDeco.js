...
export class FineSponsaliaDeco extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('salutoSponsalia', 'assets/sponsalia/fine-sponsalia.png');
    }
    ...
    create(data) {
        ...
        const salutoImage = this.add.image(this.cameras.main.centerX, this.cameras.main.height * 0.1, 'salutoSponsalia')
            .setOrigin(0.5, 0);
